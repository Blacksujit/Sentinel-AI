...
- **Explains every score** with token-level reasons — not a black box
- **Acts on risk** — serve, auto-correct, or block and escalate
...
flowchart LR
    ...
    Policy -->|25-59 Review| Fix[Auto-correct]
...
<Cards>
  ...
  <Card title="Detectors" description="The six parallel risk signals" href="/docs/detectors" />
